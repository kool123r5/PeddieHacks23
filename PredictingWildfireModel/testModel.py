...
# count = 0
# total = 0
# for file in os.listdir('/Users/kushalb/Downloads/fireData/test/wildfire'):
#     if total == 1000:
#         break
#     total = total + 1
#     predicted_class = predict_class(os.path.join('/Users/kushalb/Downloads/fireData/test/wildfire', file))
